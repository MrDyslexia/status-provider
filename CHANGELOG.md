...
- Compact session status now shows reset countdowns with days, hours, and
  minutes instead of rounding to the largest unit.
...
[0.2.1]: https://github.com/MrDyslexia/status-provider/compare/v0.2.0...v0.2.1
