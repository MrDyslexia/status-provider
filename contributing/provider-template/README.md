...
| `provider.ts`      | `src/providers/<provider>.ts`         | Register availability, model matching, and status fetch mapping. |
...
- `README.md`
- `/status-provider-info` diagnostics when the provider exposes auth-source details
