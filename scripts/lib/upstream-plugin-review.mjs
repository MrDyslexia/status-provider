...
export function buildUpstreamPluginReviewPrompt({
  ...
  const lines = [
    "Please check whether these upstream plugin updates conflict with the current local status-provider plugin.",
    "",
    "Updated plugins:",
  ];
  ...
  lines.push(
    "",
    "If you find no conflicts, I plan to close the GitHub issue manually. If you find conflicts, tell me exactly what changed in status-provider and what should be fixed before I push to main and cut a release.",
  );
