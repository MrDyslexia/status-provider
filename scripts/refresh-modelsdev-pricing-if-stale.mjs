...
export async function main() {
  if (!parseEnabled(process.env.OPENCODE_STATUS_PRICING_AUTO_REFRESH)) {
    console.log("Skipping pricing auto-refresh: OPENCODE_STATUS_PRICING_AUTO_REFRESH disables it.");
    return;
  }

  const maxAgeMs = parseMaxAgeMs(process.env.OPENCODE_STATUS_PRICING_MAX_AGE_DAYS);
