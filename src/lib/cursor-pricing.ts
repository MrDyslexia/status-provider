import type { CursorStatusPlan } from "./types.js";
import type { CostBuckets } from "./modelsdev-pricing.js";
import { getStatusProviderRuntimeIds } from "./provider-metadata.js";
...
export const CURSOR_INCLUDED_API_USD_BY_PLAN: Readonly<Record<Exclude<CursorStatusPlan, "none">, number>> = {
  pro: 20,
  "pro-plus": 70,
  ultra: 400,
};
...
const CURSOR_PROVIDER_IDS = new Set([
  ...getStatusProviderRuntimeIds("cursor"),
  "open-cursor",
...
export function getCursorPlanDisplayName(plan: CursorStatusPlan): string | null {
  switch (plan) {
    case "pro":
      return "Pro";
    case "pro-plus":
