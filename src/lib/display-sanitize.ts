...
export function sanitizeStatusProviderEntry(entry: StatusProviderEntry): StatusProviderEntry {
...
export function sanitizeStatusProviderError(error: StatusProviderError): StatusProviderError {
  return {
...
export function sanitizeStatusProviderResult(result: StatusProviderResult): StatusProviderResult {
  return {
    attempted: result.attempted,
    entries: result.entries.map(sanitizeStatusProviderEntry),
    errors: result.errors.map(sanitizeStatusProviderError),
  };
}
...
export function sanitizeStatusRenderData(data: StatusRenderData): StatusRenderData {
  return {
    entries: data.entries.map(sanitizeStatusProviderEntry),
    errors: data.errors.map(sanitizeStatusProviderError),
