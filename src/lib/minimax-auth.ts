...
import type { MiniMaxStatusEndpointId } from "./minimax-endpoints.js";
...
export type ResolvedMiniMaxAuth =
  | { state: "none" }
  | { state: "configured"; apiKey: string; endpoint: MiniMaxStatusEndpointId }
...
): { state: "configured"; apiKey: string; endpoint: MiniMaxStatusEndpointId } | null {
