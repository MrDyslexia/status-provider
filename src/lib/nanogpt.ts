/**
 * NanoGPT live status and balance fetcher.
 *
 * Queries:
...
import type { StatusError } from "./types.js";
...
export async function queryNanoGptStatus(options: { requestTimeoutMs?: number } = {}): Promise<NanoGptResult> {
